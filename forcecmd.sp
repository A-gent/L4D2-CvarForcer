...
public Plugin myinfo = 
{
	name = "CvarForcer", 
	author = "Agent, ReyZ", 
	description = "Forces a Player to use a Command", 
	version = "1.1", 
	url = "https://github.com/A-gent/L4D2-CvarForcer", 
};
...
public void OnPluginStart()
{
	...
	RegAdminCmd("sm_cvarforcer", forcecmd, permission);
	RegAdminCmd("cvarforcer", forcecmd, permission);
	RegAdminCmd("cvarforce", forcecmd, permission);
	RegAdminCmd("cvarf", forcecmd, permission);
}
